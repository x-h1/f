#!/bin/bash
source anu
wget -O /usr/local/bin/ws-openssh ${anu}openssh-socket.py
wget -O /usr/local/bin/ws-dropbear ${anu}dropbear-ws.py
wget -O /usr/local/bin/ws-stunnel ${anu}ws-stunnel
...
wget -O /etc/systemd/system/ws-dropbear.service ${anu}service-wsdropbear && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service ${anu}ws-stunnel.service && chmod +x /etc/systemd/system/ws-stunnel.service
